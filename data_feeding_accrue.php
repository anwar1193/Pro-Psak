            ...
            <div class="box box-default">
              <div class="box-header with-border">
                ...
                <div class="tombol-export" style="position: absolute; top:50%; right: 2%;">
                  <form method="post" action="excel_data_psak_accrue.php">
              ...
              <div class="box-body">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td style="text-align: center">
                        <a href="detail_accrue.php?no_pin='<?php echo $row['no_pin'] ?>'" class="btn btn-warning btn-xs">
                ...
                <a href="delete_accrue.php" class="btn btn-default btn-xs" onclick="return confirm('Apakah anda yakin?')">
                  Hapus Accrue
                </a>
