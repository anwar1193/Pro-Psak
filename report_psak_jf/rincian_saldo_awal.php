<?php  
	...
	header("Content-Disposition: attachment; filename=laporan_rincian_saldo_awal_jf.xls");
...
<body>
    ...
    <h2>LAPORAN RINCIAN SALDO AWAL JF</h2>
    ...
    <table border="1" cellspacing="0" cellpadding="5px">
        ...
        <?php  
            ...
            if($fincat_saldo_awal=='all'){
                $query = "SELECT * FROM tbl_jf WHERE MONTH(tanggal_upload)='$bulan_saldo_awal' AND YEAR(tanggal_upload)='$tahun_saldo_awal'";
                ...
                $query = "SELECT * FROM tbl_jf WHERE MONTH(tanggal_upload)='$bulan_saldo_awal' AND YEAR(tanggal_upload)='$tahun_saldo_awal' AND fincat='$fincat_saldo_awal'";
