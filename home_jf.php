        ...
        <div class="container-fluid">
          ...
          <section class="content">
            ...
            <div class="box box-default">
                ...
                <h3 class="box-title">Rekap Mutasi JF (By Account Sts) - <?php echo $nama_bulan.' '.$tahun_jf ?></h3>

                <!-- Tombol Kiri -->
                <div style="position:absolute; left:0; top:0">

                  <a href="home.php" class="btn btn-warning"> Data PSAK Nasabah</a>
                  <a href="home_jf.php" class="btn btn-warning" style="transform:translateY(-10px)"> Data PSAK JF</a> 
