<?php  
	...
	header("Content-Disposition: attachment; filename=data_fidding_psak.xls");
...
<div>
	<span style="margin-left: 20px; font-size: 20px"><b>Data Fidding PSAK <?php echo $status_penyusutan ?></b></span><br>
</div>
