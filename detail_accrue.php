      ...
      <div class="content-wrapper">
        <div class="container-fluid">
          ...
          <section class="content-header">
            <h1>
              Data Accrue
              <small>Data Feeding Accrue</small>
            </h1>
            <ol class="breadcrumb">
              <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
              <li class="active">Generate Accrue</li>
            </ol>
          </section>
          ...
          <section class="content">
            <div class="box box-default">
              <div class="box-header with-border">
                <h3 class="box-title">Data Fidding Accrue (Generated)</h3>

                <span style="margin-left: 93%;">
                  <a href="data_feeding_accrue.php" class="btn btn-info btn-xs">Kembali</a>
                </span>
              </div>
              <div class="box-body">

                <?php  
                  $res = tampil_accrue_nopin($_GET['no_pin']);
                ...
                <table class="table table-bordered">
                  ...
                  <?php  
                    $no=0;
                    $result = tampil_accrue_detail($_GET['no_pin']);
                ...
                <table class="table table-bordered">
                  <tr>
                    <th>#</th>
                    <th>Provisi accrue</th>
                  </tr>

                  <?php  
                    $no=0;
                    $result_salaw = tampil_saldo_awal_accrue($_GET['no_pin']);
                    $row_salaw = mysqli_fetch_array($result_salaw);
                  ?>

                  <tr>
                    <td style="font-weight:bold">SALDO AWAL</td>
                    <td style="text-align: right;"><?php echo number_format($row_salaw['accrue_restru'],0,'.',',') ?></td>
                  </tr>


                  <?php  
                    $no=0;
                    $result_penyusutan = tampil_penyusutan_accrue($_GET['no_pin']);
                  ...
                  <?php }else{ ?>
                    ...
                    <tr>
                      <td style="font-weight:bold">TOTAL PENYUSUTAN</td>
                      <td style="text-align: right;"><?php echo number_format($row_penyusutan['accrue_restru_p'],0,'.',',') ?></td>
                    </tr>
                  ...
                  <?php  
                    $no=0;
                    $result_salakh = tampil_saldo_akhir_accrue($_GET['no_pin']);
                  ...
                  <?php }else{ ?>
                    ...
                    <tr>
                      <td style="font-weight:bold">SALDO AKHIR</td>
                      <td style="text-align: right;"><?php echo number_format($row_salakh['accrue_restru_akh'],0,'.',',') ?></td>
                    </tr>
