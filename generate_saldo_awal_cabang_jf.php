...
<?php  
    ...
    $query = "SELECT 
                ...
                FROM tbl_jf_detail GROUP BY cabang, fincat";
    ...
    while($row = mysqli_fetch_array($result)){
        ...
        $query_simpan = "INSERT INTO tbl_saldo_awal_cabang_jf(cabang, fincat, bulan, tahun, provisi_jf) VALUES('$cabang', '$fincat', '$bulan', '$tahun', $provisi_jf)";

        mysqli_query($koneksi, $query_simpan);
    }

    echo '<script>
		alert("Generate Sukses");window.location="data_feeding_jf.php";
	</script>';
?>
