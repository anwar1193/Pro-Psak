<?php  
    ...
    while($row = mysqli_fetch_array($result)){
        ...
        $query_simpan = "INSERT INTO tbl_saldo_awal(fincat, bulan, tahun, refund_npv, refund_asuransi, refund_adm, ins_receivable, by_notaris, pend_asuransi, pend_survey, pend_fidusia, pend_provisi) VALUES('$fincat', '$bulan', '$tahun', $refund_npv, $refund_asuransi, $refund_adm, $ins_receivable, $by_notaris, $pend_asuransi, $pend_survey, $pend_fidusia, $pend_provisi)";
