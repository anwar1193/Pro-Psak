...
?>
  <tr>
    ...
    <td style="text-align: right;"><?php echo number_format($data_active_invst['t_pend_provisi'],0,'.',',') ?></td>
  </tr>
  ...
  <tr>
    ...
    <td style="text-align: right;"><?php echo number_format($data_active_mtgna['t_pend_provisi'],0,'.',',') ?></td>
  </tr>
  ...
  <tr>
    ...
    <td style="text-align: right;"><?php echo number_format($data_active_mkrja['t_pend_provisi'],0,'.',',') ?></td>
  </tr>
